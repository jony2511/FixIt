@php
    ...
    $innerClasses = $usingSidebar ? 'max-w-7xl mx-auto space-y-6' : 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6';
@endphp
...
@if($usingSidebar)
    ...
    @section('page-description', 'Detailed product information')
@endif

@php
    ...
    $innerClasses = $usingSidebar ? 'max-w-7xl mx-auto space-y-8' : 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8';
@endphp
...
@if($usingSidebar)
    ...
    @section('page-description', 'Insights from our data science and AI experts')
@endif

                        ...
                        <div class="p-6 hover:bg-gray-50 transition">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-right">
                                    <p class="text-lg font-bold text-gray-900">Tk.{{ number_format($order->total_amount, 2) }}</p>
                        ...
                        document.getElementById('trackingContent').innerHTML = `
                            <div class="text-left space-y-4">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${statusColors[order.order_status] || 'text-gray-600 bg-gray-100'}">
                                        ${order.order_status.charAt(0).toUpperCase() + order.order_status.slice(1)}
                                    </span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm font-medium text-gray-600">Total Amount:</span>
                                    <span class="text-sm font-medium text-gray-900">Tk.${order.total_amount}</span>
                                </div>
                                <div class="flex justify-between items-center">
